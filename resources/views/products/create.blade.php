...
<body>
    <div>
        ...
        <form method="post" action="{{route('product.store')}}" id="product-form">
            ...
            <div class="form-group">
                <label>Qty</label>
                <input type="text" name="qty" placeholder="Qty" pattern="[0-9]*" required>
            </div>
            <div class="form-group">
                <label>Price</label>
            ...
            <div class="form-group">
                <input type="submit" value="Save a New Product" id="submit-btn">
            </div>
        </form>
    ...
    <script>
        ...
        form.addEventListener('submit', function(event) {
            ...
            // Only allow numbers in Qty and Price fields
            if (isNaN(form.qty.value) || isNaN(form.price.value)) {
                showPopup();
                return;
            }
